...
for i in range(min, max, steps):
    ...
    # omit missing files 
    string = "/Users/Hirst/Documents/PhD/sus_test/txtfiles/mag_tsteps_100000_T_" + str(i) + ".txt"
...
np.savetxt("/Users/Hirst/Sus_af_gga.txt", np.c_[T, SusX, SusY, SusZ, SusT], fmt='%s')
